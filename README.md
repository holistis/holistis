...
Fixed: [pymc-marketing](https://github.com/pymc-labs/pymc-marketing/pull/2984), reported by email the same night, the maintainer credited the report and merged a fix within a day.
