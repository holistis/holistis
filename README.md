...
- - HR teams running employee wellness checks at scale
  - - Holistic practitioners who want their own client portal
    ...
    **[muraqib](https://github.com/holistis/muraqib)** — a nightly QA guardian for solo SaaS founders. Playwright tests your live app every night, Claude fixes failing tests automatically, you get one weekly email. Zero-maintenance monitoring for one-person teams.
